...
CREATE TABLE IF NOT EXISTS settings (
  ...
  primary_color TEXT DEFAULT '#C8A45C',
  secondary_color TEXT DEFAULT '#B8933D',
  accent_color TEXT DEFAULT '#D4C9C0',
  ...
  featured_dish_image TEXT DEFAULT '',
  featured_dish_1_image TEXT DEFAULT '',
  featured_dish_2_image TEXT DEFAULT '',
  featured_dish_3_image TEXT DEFAULT '',
  featured_dish_4_image TEXT DEFAULT '',
  full_house_image TEXT DEFAULT '',
