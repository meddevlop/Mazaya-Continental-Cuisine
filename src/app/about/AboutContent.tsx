...
export default function AboutContent({ name, nameAr, storyImage }: AboutContentProps) {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center mb-24">
            ...
            <AnimatedSection direction="right" delay={0.15}>
              ...
              <div className="space-y-5 text-[#6B5E56] leading-relaxed">
                <p>
                  Welcome to <strong>{name}</strong>, where the rich traditions of Middle Eastern
