        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {items.map((dish, index) => (
            ...
            >
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] border border-white/[0.06] rounded-xl p-6 md:p-7 flex flex-col justify-end">
